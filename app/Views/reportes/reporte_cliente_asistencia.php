...
<script>
    function exportarTablaAPDF() {
        ...
        var filename = 'reporte_asistencias_' + timestamp + '.pdf'; // Nombre del archivo con el timestamp


        // Definir la estructura del documento PDF
        var docDefinition = {
            content: [{
                text: 'Reporte de Asistencias', // Título de la tabla
                ...
                table: {
                    ...
                    body: [
                        ['ID', 'Cliente', 'Paquete', 'Sesiones', 'Usuario', 'Fecha'], // Cabecera de la tabla
