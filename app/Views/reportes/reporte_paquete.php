...
<script>
    function exportarTablaAPDF() {
        ...
        var filename = 'reporte_paquetes_' + timestamp + '.pdf'; // Nombre del archivo con el timestamp


        // Definir la estructura del documento PDF
        var docDefinition = {
            content: [{
                text: 'Reporte de Inscritos', // Título de la tabla
                ...
                table: {
                    ...
                    widths: ['*', '*', '*', '*', '*', '*', '*'],
                    body: [
                        ['Paquete', 'Sesiones', 'Precio', 'Inscrito', "Saldo", "Fecha Inscripción", "Usuario Inscripción"], // Cabecera de la tabla
