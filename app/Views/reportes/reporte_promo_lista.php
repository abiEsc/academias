...
<div class="table-responsive">
    <table class="table" id="reporte_promos">
        <thead>
            <tr>
                <th>Nro</th>
                <th>Promoción</th>
        ...
        <tbody>
            <?php foreach ($reporte as $key => $item) : ?>
                <tr>
                    ...
                    <td><?php echo $item["promocion_inicio"] ?></td>
                    <td><?php echo $item["promocion_fin"] ?></td>
                    <td><?php echo $item["estado"] ?></td>
                    <td><?php echo $item["accion_usuario"] ?></td>
                    <td><?php echo $item["accion_fecha"] ?></td>
                </tr>
            <?php endforeach ?>
        </tbody>
    </table>
...
<script>
    function exportarTablaAPDF() {
        var tabla = document.getElementById('reporte_promos');
        var tablaData = [];
        ...
        var filename = 'reporte_promociones_' + timestamp + '.pdf'; // Nombre del archivo con el timestamp


        // Definir la estructura del documento PDF
        var docDefinition = {
            content: [{
                text: 'Reporte de Promociones', // Título de la tabla
                ...
                table: {
                    ...
                    body: [
                        ['ID', 'Promoción', 'Sesiones', 'Precio', 'Vig - Inicio', 'Vig - Fin', 'Estado', 'Usuario', 'Fecha'], // Cabecera de la tabla
