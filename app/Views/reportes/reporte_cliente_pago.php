        ...
        <tbody>
            <?php foreach ($reporte as $key => $item) : ?>
                <tr>
                    ...
                    <td><?php echo $item["paquete_nombre"] ?></td>
                    <td><?php echo $item["paquete_cantidad_clases"] ?></td>
                    <td><?php echo $item["pago_monto"] ?> Bs.</td>
                    <td><?php echo $item["paquete_precio"] ?> Bs.</td>
...
<script>
    function exportarTablaAPDF() {
        ...
        var filename = 'reporte_pagos_' + timestamp + '.pdf'; // Nombre del archivo con el timestamp
        ...
        var docDefinition = {
            content: [{
                ...
                table: {
                    ...
                    body: [
                        ['ID', 'Cliente', 'Paquete', 'Sesiones', 'Cancelado', 'Precio', 'Usuario', 'Fecha'], // Cabecera de la tabla
